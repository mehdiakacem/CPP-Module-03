...
/*   Updated: 2023/04/27 14:36:53 by makacem          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "Default constructor for " << getName() << " called" << std::endl;
}

ClapTrap::ClapTrap(std::string name)
: _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
    std::cout << "Constructor for " << getName() << " called" << std::endl;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << "Destructor for "<< getName() << " called" << std::endl;
}
